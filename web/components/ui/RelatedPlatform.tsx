    ...
    <div className="rounded-2xl border border-slate-200/80 bg-slate-50/60 p-5">
      ...
      <div className="space-y-1">
        {platformLinks.map((l) => (
          ...
          >
            <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white group-hover:border-line group-hover:bg-paper-dim transition">
              {l.icon}
            </div>
            <div>
              <p className="text-sm font-medium text-slate-900 group-hover:text-ink transition-colors">
                {l.label}
              </p>
